...
![Protea eximia. photo: Gawie Malan CC BY-NC](protea_eximia_gawie_malan.jpg)
...
![Fitting the Proteas vs Restios image classifier with Keras 2.0](image_acc.png)
...
![Some Restios in the validation dataset](r_col.png)

![Some Proteas in the validation dataset](p_col.png)
