...
::: {.article__head}
<div class="article__meta"><span>2017 · 11 · 15</span><span>·</span><span>4 min read</span><span>·</span><span style="color:var(--accent);">Remote Sensing</span></div>

# EMMA wins the UN Data for Climate Action challenge

<p class="hero__tag" style="text-align:left; margin:0; max-width:62ch;">Predicting post-fire recovery in the fynbos and monitoring vegetation anomalies.</p>
:::
...
![Protea cynaroides. Image: Adam Wilson.](king-protea.jpg)
...
![A screenshot of the EMMA web application.](emma.png)
