...
![It works on my computer.](machine.jpg)
...
![A basic ggplot of the iris dataset.](unnamed-chunk-5-1.png)
...
![A gauging weir used to measure streamflow.](weir.jpeg)

We would like understand how the streamflow reduction caused by the plantation increases as the plantation gets older and the impact of planting different species. The full report on these experiment, from which these data were transcribed is available [here](http://www.wrc.org.za/wp-content/uploads/mdocs/810-1-00.pdf)
...
![Fitted streamflow-reduction curves for the two tree genera.](unnamed-chunk-9-1.png)
...
![The launch-binder badge.](launch.png)
...
### Create a research compendium with holepunch
...
Before running this though it can be useful to set some options regarding author details that will automatically be written to the `DESCRIPTION` file. This will reduce the amount of manual editing we will need to do to this file
