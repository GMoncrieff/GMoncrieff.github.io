...
::: {.article__head}
<div class="article__meta"><span>2018 · 10 · 31</span><span>·</span><span>6 min read</span><span>·</span><span style="color:var(--accent);">Remote Sensing</span></div>

# Real-time detection of land cover change

<p class="hero__tag" style="text-align:left; margin:0; max-width:62ch;">Detecting vegetation clearing using Sentinel 2 time series.</p>
:::
...
![The Albany thicket biome.](thicket.jpg)
...
![Planet imagery timelapse, late January to early February 2018.](pl_gif.gif)
...
![A stack of NDVI images through time.](stack.jpg)
...
![The BFAST approach to detecting breaks in an NDVI time series.](bf3.png)
...
![BFAST applied to the Planet NDVI series, with the breakpoint detected on 2 February.](pl_bf.jpg)
...
![The detected clearing highlighted as it is picked up.](pl_gif2.gif)
